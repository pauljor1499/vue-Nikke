    ...
    <div class="favourites">
      ...
      <div class="favourites-item">
        ...
        <div class="label">
          ...
          <br />
          <div class="tag">Men's Road Running Shoes</div>
        </div>
      </div>
    </div>
    <div class="title">
...
.content .favourites .label {
  width: 90%;
  margin: auto;
  overflow: hidden;
}

.content .favourites .name {
  font-size: 16px;
  float: left;
}

.content .favourites .price {
  font-size: 16px;
  float: right;
}

.content .favourites .tag {
  font-size: 15px;
  color: gray;
  float: left;
}
